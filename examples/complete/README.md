...
- This example creates a new global rds cluster containing a primary and secondary cluster.
...
| <a name="provider_aws.secondary"></a> [aws.secondary](#provider\_aws.secondary) | 5.24.0 |
